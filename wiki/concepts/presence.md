...
sources:
  - "[[src_everything-is-a-win-when-the-goal]]"
...
Trạng thái hiện diện hoàn toàn trong khoảnh khắc hiện tại, cảm nhận thế giới thông qua các giác quan mà không phán xét, không cố gắng biến khoảnh khắc đó thành một công cụ hay kết quả cho mục đích nào khác. Presence không đòi hỏi điều kiện đặc biệt — nó có thể xảy ra trong những việc bình thường nhất như cảm nhận mùi vị trái cây hay ánh nắng chiều. Đây là trạng thái "being" thuần khiết, đối lập với trạng thái "doing" và "proving" của xã hội hiện đại.

## Key ideas

- Sự hiện diện thuần túy có thể tìm thấy trong những điều bình thường nhất (ví dụ: hương vị quả cam, ánh nắng chiều) — không cần điều kiện đặc biệt.
