...
Ba lớp của một agent hữu ích trong Hermes: Layer 1 — Identity (Soul.md, ROI cao nhất), Layer 2 — Knowledge (User.md + Memory), Layer 3 — Tools (Config + Skills). Thứ tự ưu tiên quan trọng: Identity quyết định mọi thứ downstream.
