...
- **Pattern vs. Judgment:** AI giỏi pattern recognition; con người cần quyết định what matters
- **Dynamic modeling:** AI giúp chuyển từ static plans sang dynamic models of change

## When to Apply

- Complex problem analysis với nhiều stakeholders
- Scenario planning và risk assessment
- Causal loop diagram building
- Stakeholder mapping

## Limitations

- AI cannot fully understand context, values, power, trust, purpose
