...
### Autonomous Science
- Research system thiết kế thí nghiệm qua đêm, đặt mua reagents, chạy vòng lặp không cần sinh viên trong phòng lab

## Three Shifts Enabling Machine Economy
...
- Protocols: x402, MPP, AP2 — cho agents cách để thanh toán
- Faster blockchain và fiat networks meeting in the middle
...
Legacy financial rails built around:
- Identity you can verify
- Intent you can dispute
- A person you can hold responsible

Crypto rails built around:
- Code you can audit
- On-chain records anyone can read
- Rules the network enforces

→ Khi actor là autonomous, sự khác biệt này chuyển từ gap thành **the point**
...
- [[agentic-commerce]] — giao thương giữa các agents
- [[autonomous-agents]] — các tác nhân tự chủ
