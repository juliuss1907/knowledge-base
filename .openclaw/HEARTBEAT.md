_Last check: 2026-05-14 10:00 Asia/Saigon (2026-05-14 03:00 UTC)_
...
- Host: `julius-vps`
- Host uptime: `1 day, 18 hours, 47 minutes`
- Load average: `0.72 0.36 0.31`
...
- Gateway: running via user systemd; bind `127.0.0.1`; port `18789`; RPC probe previously `ok`
