...
def load_taxonomy():
    ...
    # Split by sections using a simpler method
    parts = re.split(r'## \d+\. Pool [AB]', content)
    # parts[0] is everything before Pool A
    # parts[1] is Pool A
    # parts[2] is Pool B
