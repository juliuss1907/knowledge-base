...
Furthermore, simple is as simple does. A conclusion can't rely just on its simplicity. It must be backed by empirical evidence. And when using Occam's razor to make deductions, we must avoid falling prey to confirmation bias. In the case of the NASA moon landing conspiracy theory, for example, some people consider it simpler for the moon landing to have been faked, others for it to have been real. Lisa Randall best expressed the issues with the narrow application of Occam's razor in her book, Dark Matter and the Dinosaurs:
