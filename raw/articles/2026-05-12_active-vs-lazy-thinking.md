...
This is a memo I sent to the [Scale](https://scale.com) team earlier this year—I think it is critical to maintaining efficacy as organizations get big. I hope you find it helpful.
...
The antidote to failure is **active thinking**. Force yourself to think in clear, verifiable hypotheses, and obtain data that validates or refutes those hypotheses. Ensure to ask questions, challenge assumptions, and identify where the real bottlenecks and constraints are. It is the only way you will be able to sort through the noise to identify the reasons you failed. On the other hand, lossy information transfer (see more: [Information Compression](https://alexw.substack.com/p/information-compression)) results in unchecked assumptions being propagated.
...
The necessity to be an active thinker is the core of our credos: [Intellectual rigor, open mind](https://scale.com/careers#credos). We think in clear verifiable hypotheses and continuously obtain data that validates or refutes them. We ask questions and challenge assumptions to get consistently to the truth.
