...
In the natural world, this third law of Newton's explains jet propulsion. The word propulsion comes from two Latin terms meaning "forward" and "drive"—propulsion is a force that drives an object forward. Jet propulsion works by forcing matter, such as gas produced by burning fuel, in one direction, leading to a corresponding movement of the vehicle in the opposite direction. This holds true for everything from fireworks and guns to huge spacecraft.
