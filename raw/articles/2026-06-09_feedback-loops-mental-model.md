...
type: raw
source_type: article
source_url: https://fs.blog/mental-model-feedback-loops/
date_ingested: 2026-06-09
tags: []
status: processed
compiled_at: 2026-06-10
compiled_to: "[[src_feedback-loops-mental-model]]"
---

# Mental Model: Feedback Loops

Source: [Farnam Street](https://fs.blog/mental-model-feedback-loops/)
...
### Charlie Munger on the 2008/2009 Credit Crisis
...
For example, when stocks become too cheap in relation to the replacement cost of the underlying assets, there is no incentive to create new capacity and industry consolidation is likely to take place wherein the strong players in an industry, instead of creating new capacity, buy out competitors.
...
### Michael Mauboussin: Super-linear vs Sub-linear Systems

The last idea has to do with systems that exhibit super-linear behavior vs. those that exhibit sub-linear behavior. In the super-linear systems, when you add more, you create more: there's a positive feedback loop. One of the most direct uses of this in markets is network effects — the value of a good or service increases as more people use that good or service.
...
### Network Effects as Positive Feedback

In super-linear systems, when you add more, you create more — there's a positive feedback loop. Network effects mean the value of a good or service increases as more people use that good or service.

Examples:
- **eBay** — Auction business with clear network effects
- **PayPal** — Payment business benefiting from network effects
- **Skype** — Network effects business (acquired by eBay)

---

## Ant Behavior and Feedback Loops

Michael Mauboussin offered an example of ants and positive feedback:
...
|------|--------|----------|
| **Negative Feedback** | Stabilizes, dampens output | Thermostat, body temperature, Segway, market corrections |
| **Positive Feedback** | Amplifies, creates growth/decline | Stock bubbles, network effects, ant trails, Amazon deforestation |

---

## Key Takeaways

- **Negative feedback loops** maintain equilibrium and stability through self-correction.
- **Positive feedback loops** amplify changes, creating exponential growth or decline.
- Most real-world systems contain **both types** interacting.
- **Unintended consequences** arise when designers don't consider behavioral changes (e.g., football helmets).
- **Network effects** are business examples of positive feedback.
- **Markets** operate in negative feedback loops long-term, but experience positive feedback bubbles short-term.
- **Nature programs diversity** to break dangerous positive feedback cycles (e.g., ants' random exploration).
- Feedback loops are **fundamental to learning** — trial and error, course correction.

---

*Feedback loops are part of the Farnam Street [Latticework of Mental Models](https://fs.blog/mental-models/).*