...
## Agent health
- Status: healthy
- Last checked: 2026-05-20 14:30:00 Asia/Saigon
- Host: `julius-vps`
- Host uptime: `14:30:58 up 7 days, 23:17,  1 user,  load average: 0,32, 0,38, 0,49`
- Load average: healthy — 0,32, 0,38, 0,49
- Memory: healthy — `BNhớ:           13Gi       6,4Gi       1,5Gi        57Mi       6,0Gi       7,2Gi`
- Swap: healthy — `Tráo đổi:       17Gi       6,3Gi        11Gi`
...
- 2 sampled concept file(s) checked; at least one still uses legacy full-path source wikilinks already listed in pending reviews.
