...
- Prompting the LLM to “write it at a 6th grade level (https://x.com/ahall_research/status/2083224468248518845)” works decently as a blunt instrument to take to your prose.

## Voice hallmarks: Alexa voice

There are roughly one million (https://www.merriam-webster.com/help/faq-how-many-english-words) words in the English language. Default AI writing sounds like it’s working with about four hundred of them. But rather than trying to pinpoint which word of the day is an AI hallmark, the test here should be fungibility (https://www.youtube.com/watch?v=McTJft7wQzY): could this sentence be taken word-for-word out of your writing and dropped into someone else’s essay on a different topic without anyone noticing?

For a while you could track this category of low-friction vocabulary empirically. Researchers famously noticed (https://arxiv.org/abs/2504.13038) the word “delve” spiking in academic abstracts after ChatGPT launched in 2022, and an onslaught of banned-word lists followed: tapestry, testament, underscore; more recently, load-bearing, scaffolding, broader, etc.

In the meantime, thoughtful diction isn’t just a preoccupation of “literary” writers. It matters for anyone who starts or runs a company because people increasingly market (https://a16zcrypto.com/posts/podcast/marketing-101-startups-token-launches-memes-devs) on the strength of their personalities.
...
We group ideas into three because three feels complete (https://en.wikipedia.org/wiki/Rule_of_three_(writing)). We add signposts (e.g., “First,...” or “In other words, …”) to instantly situate readers within our writing. We create neat little taxonomies because they’re easier to skim.
...
The em dash — now a canonical AI tell — has always been divisive (https://99percentinvisible.org/episode/658-the-em-dash/) (😏). Strunk and White advise restraint more generally: “Use a dash only when a more common mark of punctuation seems inadequate.” But there’s a very easy, conversational feel to em dashes, in particular, that no other punctuation mark really has.
...
- Em dash clustering. Not the dash itself, but the density, especially paired with lists and asides. There’s not really a numerical limit on the number of em dashes you can use in a sentence, but don’t (https://www.chicagomanualofstyle.org/qanda/data/faq/topics/HyphensEnDashesEmDashes/faq0002.html) use more than two.
...
---
As more people use these tools, interrogating whether something is machine-generated is becoming kind of pointless. The answer is almost always going to be “to some degree.” Of course, the egregious cases of AI writing still need outing, whether by our own standards or Proof of Person technologies (https://a16zcrypto.com/posts/tags/proof-of-human-person-unique-personhood/): for example, when disclosure is required, when the human on the byline is the whole point, or when one person is pretending to be a thousand.
...
---
Acknowledgments: Thanks to the a16z crypto (https://open.substack.com/users/84770100-a16z-crypto?utm_source=mentions) editorial team — Tim Sullivan (https://open.substack.com/users/1509204-tim-sullivan?utm_source=mentions), Robert Hackett (https://open.substack.com/users/75464871-robert-hackett?utm_source=mentions), and Sonal Chokshi (https://open.substack.com/users/50928-sonal-chokshi?utm_source=mentions) — for feedback on this post, and for the many years of edits and debates that informed it.
