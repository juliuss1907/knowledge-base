...
type: raw
source_type: article
source_url: https://x.com/i/status/2064374643729773029
source_name: X (Twitter) — @0xCodez
...
**Source:** X Article — https://x.com/i/status/2064374643729773029
**Metrics:** 6,277 likes · 1,022 retweets · 131 quotes · 7.1M views · 20,243 bookmarks
...
3. Skills (project knowledge once, read on every run)
4. Connectors (MCP touches your real tools)
5. Sub-agents (keep the maker away from the checker)
6. State files (the agent forgets, the file does not)
...
This is the evaluator-optimizer pattern from Anthropic's December 2024 engineering post under a new name. One model generates, another critiques, repeat.
